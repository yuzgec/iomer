                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <ul class="list list-icons list-icons-lg">
                            ...
                            <li class="mb-1"><i class="fas fa-phone text-color-primary"></i><p class="m-0"><a href="tel:{{ config('settings.telefon1')}}">{{ config('settings.telefon1')}}</a></p></li>
                            <li class="mb-1"><i class="fas fa-phone text-color-primary"></i><p class="m-0"><a href="tel:{{ config('settings.telefon2')}}">{{ config('settings.telefon2')}}</a></p></li>
                            <li class="mb-1"><i class="far fa-envelope text-color-primary"></i><p class="m-0"><a href="mailto:{{ config('settings.email1')}}">{{ config('settings.email1')}}</a></p></li>
                        </ul>
                    </div>
