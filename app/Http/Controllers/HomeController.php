...
class HomeController extends Controller
{
    public function index(){
        ...
        SEOMeta::setTitle("İomer Atık");
        SEOMeta::setDescription("İomer Atık");
    ...
    public function categorydetail($url)
    {
        ...
        SEOMeta::setTitle($Detay->title.' | İomer Atık');
        SEOMeta::setDescription("İomer Atık");
        SEOMeta::setCanonical(url()->full());
    ...
    public function partdetail($url)
    {
        ...
        views($Detay)->cooldown(60)->record();
        SEOMeta::setTitle($Detay->title.' | Yedek Parça | İomer Atık');
        SEOMeta::setDescription("İomer Atık");
        SEOMeta::setCanonical(url()->full());
        return view('frontend.product.index', compact('Detay'));
    }
    ...
    public function contactus(){
        ...
        SEOMeta::setTitle('İletişim | İomer Atık');
        SEOMeta::setDescription("İomer Atık");
        SEOMeta::setCanonical(url()->full());
